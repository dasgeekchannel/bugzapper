...
def clicked_full(): #defining action of command clicked for btnfullsys below
    myCmd = 'cat /var/log/syslog > systemreport.txt' # define command and output result to a file named systemreport.txt/ testing with ls
...
def clicked_start(): #defining action of command clicked for btnfullsys below
    myCmd = 'cat /var/log/bootstrap.log > bootstrap.txt' # define command and output result to a file named systemreport.txt/ testing with ls
    os.system(myCmd) #send command to shell
...
def clicked_hard(): #defining action of command clicked for btnfullsys below
    myCmd = 'lshw > hardware.txt' # define command and output result to a file named systemreport.txt/ testing with ls
    os.system(myCmd) #send command to shell
